  ...
  return (
    <main className="page-shell">
      ...
      <section className="decision-card loading-card" aria-busy="true">
        <p className="decision-card__eyebrow">Checking today&apos;s lowest total</p>
        <div className="decision-card__grid">
          ...
          <div className="decision-card__support">
            <div className="trust-bar">
              <span className="pill pill--quiet">Area-based comparison</span>
              <span className="pill pill--quiet">Same basket across stores</span>
              <span className="pill pill--quiet">Trust checks in progress</span>
            </div>
